...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user) {
        ...
        if ($password === $user['password']) {
            ...
            // IMPORTANT: Do NOT clear admin session variables - they can coexist independently
            // Admin and customer logins are completely separate and can both be active at the same time
            ...
            // Admin session remains active if admin was already logged in
