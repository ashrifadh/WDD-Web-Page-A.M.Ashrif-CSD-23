            ...
            if ($user) {
                ...
                if ($password_valid) {
                    ...
                    if ($isFromAdminTable) {
                        ...
                        // IMPORTANT: Do NOT clear customer session variables - they can coexist independently
                        // Customer and admin sessions can both be active at the same time
                        
                        $_SESSION['admin_user_id'] = $user['id'];
                        $_SESSION['admin_username'] = $user['username'];
                        $_SESSION['admin_role'] = 'admin';
                        $_SESSION['admin_login'] = true;
                        $_SESSION['admin_welcome_message'] = "Welcome back, " . htmlspecialchars($user['username']) . "! You have successfully logged in as admin.";
...
if (isset($_GET['logout']) && $_GET['logout'] === 'success') {
    $logout_username = isset($_GET['username']) ? htmlspecialchars($_GET['username']) : 'Admin';
    $logout_message = $logout_username . " is now offline. You have been successfully logged out.";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div id="loginForm" style="display: <?php echo $mode === 'login' ? 'block' : 'none'; ?>;">
                ...
                <?php if (!empty($logout_message)): ?>
                    <div class="info-message">
                        <i class="fas fa-sign-out-alt"></i> <?php echo htmlspecialchars($logout_message); ?>
                    </div>
                <?php endif; ?>
    ...
    <script>
        ...
        // Auto-hide logout/info messages after 3 seconds
        document.addEventListener('DOMContentLoaded', function() {
            const infoMessages = document.querySelectorAll('.info-message, .success-message');
