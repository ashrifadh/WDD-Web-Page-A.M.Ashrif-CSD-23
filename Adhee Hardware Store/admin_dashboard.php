        ...
        <main class="main-content">
            <div class="top-bar">
                ...
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <a href="admin_logout.php" style="color: var(--danger-color); text-decoration: none; font-weight: 500;">
                        <i class="fas fa-sign-out-alt"></i> Logout
                    </a>
                </div>
            </div>

            <?php if (isset($_SESSION['admin_welcome_message'])): ?>
                <div class="welcome-notification" id="welcomeMessage">
                    <div>
                        <i class="fas fa-check-circle"></i>
                        <?php echo htmlspecialchars($_SESSION['admin_welcome_message']); ?>
                    </div>
                    <button class="close-btn" onclick="document.getElementById('welcomeMessage').style.display='none'">
